          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="story-tabs">
            ...
            <TabsContent value="writing" className="tab-panel writing-panel">
              ...
              <section className="manuscript">
                ...
                <ManuscriptReader text={activeManuscript} documentKey={current.id + ":" + active.number} textareaRef={manuscriptRef} />
        ...
        <DialogContent className="manual-dialog sm:max-w-4xl">
          ...
          <div className="manual-layout">
            ...
            <div className="manual-content">
              ...
              <section id="manual-write"><h3>3. 회차 집필하기</h3><p><strong>집필</strong> 탭으로 이동한 뒤 왼쪽의 회차 번호를 고릅니다. 상단의 ‘이번 화 목표’와 ‘마지막 훅’을 참고해 가운데 원고 칸에 직접 작성하세요. 원고는 저장하기 전에도 화면에서 계속 편집할 수 있습니다.</p><p><strong>목표 글자 수</strong>에 각 회차의 분량을 입력하세요. 회차 목록에서도 한 장씩 설정할 수 있으며, 집필 화면에서 현재 글자 수와 달성률을 확인합니다. 공백 포함 1~20,000자이며 비워 두면 기본 5,000자를 사용합니다. <strong>저장</strong> 또는 <strong>원고 저장</strong>을 누르면 목표도 함께 저장됩니다. AI 집필은 해당 목표를 참고하며, 전체 설계를 다시 만들거나 복원해도 회차별 목표를 유지합니다.</p><p><strong>원고 듣기</strong>에서 회차 전체를 읽거나 원고 입력창에서 문장을 선택해 그 부분만 들을 수 있습니다. 설치된 한국어 남성 음성은 목록 위쪽에 표시되며, 없을 때는 <strong>남성 저음 톤</strong>으로 선택한 음성의 음높이를 낮출 수 있습니다. 목소리·속도·톤 설정만 이 브라우저에 기억하며, 원고와 음원은 StoryWell 서버에 저장하거나 업로드하지 않습니다.</p><p>원고가 마무리되면 <strong>완료 표시</strong>를 누르고 <strong>원고 저장</strong>으로 확정합니다. 저장하면 해당 회차의 글자 수와 상태가 작품에 반영됩니다.</p></section>
